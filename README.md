...
The installer supports apt, dnf, pacman, and zypper. It installs the app to `~/.local/share/potahunter/`, adds a launcher to `~/.local/bin/`, and creates a desktop entry. Logs are stored in `~/POTA-Hunter/`.
